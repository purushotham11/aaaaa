...
import com.web.modules.DASHBOARD.DashboardPage;
...
import com.web.modules.Widget.WidgetsPage;
...
/*	String env = System.getProperty("environment");
	...
	public void creatingView() throws FileNotFoundException, Exception {
		...
		//System.out.println("************View Creation Started**************");
		...
		/*System.out.println("************DashBoard Creation Started**************");
			
			dashboardPage.
			createDashBoard(
					PropertyReader.getPropValuesFromConfig("web.app.dashboardname", "Primeoqa"), 
					PropertyReader.getPropValuesFromConfig("web.app.dashboardwidgets", "Primeoqa"));
			
			System.out.println("************ Over Dashboard creation **************");*/
		
		System.out.println("************Widget Creation Started**************");
		
		widgetsPage.createWidget(
				PropertyReader.getPropValuesFromConfig("web.app.widgetname", "Primeoqa"),
				PropertyReader.getPropValuesFromConfig("web.app.widgetview", "Primeoqa"), 
				PropertyReader.getPropValuesFromConfig("web.app.widgetcolumns", "Primeoqa"));
		
		System.out.println("************ Over Widget creation **************");
